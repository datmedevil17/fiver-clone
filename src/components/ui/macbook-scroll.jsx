...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ...
      {/* Base area */}
      <div
        className="h-[22rem] w-[32rem] bg-[#272724] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-[#0a0e14]" />
        </div>
  ...
  return (
    (<div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#121212] rounded-2xl p-2 relative">
        <div
          style={{
      ...
      <motion.div
        ...
        <Image
          src="https://imgs.search.brave.com/w8sUAydWDHJp0_rtwDSwdmCfNE91U3da4MzRT04IkJ0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tbGxq/Mmo4eHZmbDAuaS5v/cHRpbW9sZS5jb20v/Y2I6YzVRRS4zNzI5/MC93OjExNTUvaDo3/MTUvcTptYXV0by9m/OmJlc3QvaHR0cHM6/Ly90aGVtZWlzbGUu/Y29tL2Jsb2cvd3At/Y29udGVudC91cGxv/YWRzLzIwMjMvMDcv/YXBwbHktaW1hZ2Ut/bGluay1pbi13b3Jk/cHJlc3MucG5n"
          alt="aceternity logo"
          fill
