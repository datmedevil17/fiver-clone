...
export const ContainerScroll = ({
  ...
  return (
    (<div
      className="h-[50rem] md:h-[55rem] flex items-center justify-center relative md:p-20"
      ref={containerRef}>
      <div
...
export const Header = ({
  ...
  return (
    (<motion.div
      ...
      className="div max-w-5xl mx-auto text-center  mt-4 sm:mt-8 md:mt-12 lg:mt-16">
      {titleComponent}
    </motion.div>)
  );
};
